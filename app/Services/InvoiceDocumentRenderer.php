...
class InvoiceDocumentRenderer
{
    ...
    {
        return '<style>
@page{size:A4 portrait;margin:5mm}*{box-sizing:border-box}body{margin:0;background:#f3f4f6;color:#000;font-family:Arial,Helvetica,sans-serif;font-size:10.5px;line-height:1.18}.action-bar{position:sticky;top:0;text-align:center;padding:10px;background:#f3f4f6}.action-bar button{min-height:36px;padding:7px 14px;border:1px solid #111;background:#fff;color:#111;font-weight:700;cursor:pointer}.invoice-page{width:198mm;min-height:281mm;margin:0 auto;background:#fff}.title{margin:0;padding:4px 0;border:1px solid #555;border-bottom:0;text-align:center;font-size:13px;font-weight:800}.invoice-head{display:grid;grid-template-columns:1fr 1fr;border:1px solid #555}.seller{min-height:64px;padding:6px;border-right:1px solid #555}.seller-top{display:flex;align-items:flex-start;gap:8px}.seller-logo{width:46px;max-height:46px;object-fit:contain;flex:0 0 auto}.seller h2{margin:0 0 3px;font-size:15px;text-transform:uppercase}.seller p,.bill-to p,.footer-grid p{margin:2px 0}.meta{display:grid;grid-template-columns:1fr 1fr}.meta div{min-height:27px;padding:5px;border-right:1px solid #555;border-bottom:1px solid #555}.meta div:nth-child(2n){border-right:0}.meta div:last-child{grid-column:1 / -1;border-bottom:0}.meta span,.bill-to>span,.amount-row span{display:block;font-size:9px}.meta strong{display:block;margin-top:1px}.bill-to{min-height:72px;padding:5px;border:1px solid #555;border-top:0}.bill-to h3{margin:5px 0;font-size:11px;text-transform:uppercase}.items,.amount-row table,.tax-summary{width:100%;border-collapse:collapse}.items th,.items td,.amount-row td,.amount-row th,.tax-summary th,.tax-summary td{padding:4px;border:1px solid #555;vertical-align:top}.items th,.tax-summary th{font-weight:800}.items strong{font-size:10.5px}.right{text-align:right}.center{text-align:center}.strong,.total-row td{font-weight:800}.total-row td{background:#fafafa}.amount-row{display:grid;grid-template-columns:1fr 1fr;border-left:1px solid #555;border-right:1px solid #555}.amount-row>div{min-height:70px;padding:6px;border-right:1px solid #555}.amount-row table th,.amount-row table td{border-top:0;border-right:0}.amount-row table tr:last-child td{border-bottom:0}.tax-summary th{text-align:center}.tax-summary .total-row td:first-child{text-align:right}.footer-grid{display:grid;grid-template-columns:1fr 1fr 1fr;border:1px solid #555;border-top:0}.footer-grid>div{min-height:76px;padding:6px;border-right:1px solid #555}.footer-grid>div:last-child{border-right:0}.footer-grid h4{margin:0 0 5px;font-size:10px}.signature{text-align:center}.signature p{margin-bottom:30px}.signature strong{display:block}.invoice-page table{page-break-inside:auto}.invoice-page tr{page-break-inside:avoid;page-break-after:auto}@media(max-width:820px){body{background:#fff}.invoice-page{width:100%;min-height:auto}.invoice-head,.amount-row,.footer-grid{grid-template-columns:1fr}.seller,.amount-row>div,.footer-grid>div{border-right:0}.meta{grid-template-columns:1fr}.meta div{border-right:0}.items,.tax-summary{font-size:10px}}@media print{html,body{width:200mm;min-height:0;background:#fff;overflow:hidden}.no-print{display:none}.invoice-page{width:190mm;min-height:0;height:auto;max-height:287mm;margin:0;overflow:hidden;break-after:avoid;page-break-after:avoid}.title{padding:3px 0}.seller{min-height:58px}.bill-to{min-height:64px}.amount-row>div{min-height:62px}.footer-grid>div{min-height:68px}.signature p{margin-bottom:22px}}</style>';
    }
}
