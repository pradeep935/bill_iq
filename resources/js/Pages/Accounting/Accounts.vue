...
<template>
    <Layout :page="page" :title="title">
        <template #topbar-title>
            <div class="bill-page-title"><span>ACCOUNTING</span><h1>Chart of Accounts</h1><p>System accounts, cash/bank ledgers and default posting mappings.</p></div>
        </template>
        <div class="acct-page">
            <div class="page-toolbar"><button @click="reset">New Account</button></div>
