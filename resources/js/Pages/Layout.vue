...
const sections = [
  { key: 'dashboard', label: 'ADMIN', icon: 'layout-dashboard', items: [
    { label: 'Dashboard', page: 'dashboard', href: '/app/dashboard', icon: 'layout-dashboard' },
    ...
    { label: 'Onboarding', page: 'onboarding', href: '/app/onboarding', icon: 'clipboard-check' },
  ] },
  { key: 'sales', label: 'SALES', icon: 'receipt', items: [
    ...
    { label: 'Customers', page: 'customers', href: '/app/customers', icon: 'users' },
  ...
  { key: 'purchase', label: 'PURCHASE', icon: 'shopping-bag', items: [
    { label: 'Purchases', page: 'purchases', href: '/app/purchases', icon: 'shopping-bag' },
  ...
  { key: 'stock', label: 'INVENTORY', icon: 'boxes', items: [
    { label: 'Inventory Dashboard', page: 'inventory', href: '/app/inventory', icon: 'boxes' },
    { label: 'Products', page: 'products', href: '/app/inventory/products', icon: 'tag' },
    { label: 'Current Stock', page: 'inventory-current-stock', href: '/app/inventory/stock', icon: 'warehouse' },
  ...
  { key: 'reports', label: 'REPORTS', icon: 'bar-chart', items: [
    { label: 'Reports', page: 'reports', href: '/app/reports', icon: 'bar-chart' },
  ...
  { key: 'admin', label: 'SETUP', icon: 'settings', items: [
    ...
    { label: 'Settings', page: 'settings', href: '/app/settings', icon: 'settings' },
  ] },
];
