...
const selectSingleRow = (row) => {
    selected.value = { ...selected.value, [rowKey(row)]: true };
};
...
<style scoped>
.reorder-page{padding:4px 0 72px;color:#243047}.page-head,.actions,.toolbar,.table-head,.pagination,.bulk-bar,.modal-actions,.drawer-head{display:flex;align-items:center;gap:10px}.page-head{justify-content:space-between;margin-bottom:14px}.page-head span,.drawer-head span{color:#2457d6;font-size:11px;font-weight:850}.page-head h2{margin:2px 0;color:#142139;font-weight:850}.page-head p{margin:0;color:#667085;font-size:13px}.actions{flex-wrap:wrap;justify-content:flex-end}.kpis{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;margin-bottom:14px}.kpis article{padding:13px;background:#fff;border:1px solid #e2e8f0;border-radius:8px}.kpis span{display:block;color:#667085;font-size:11px}.kpis strong{display:block;margin-top:6px;color:#101828;font-size:18px}.kpis .warning{background:#fffbeb}.kpis .warning button{margin-top:8px}.toolbar{position:sticky;top:0;z-index:40;flex-wrap:wrap;padding:12px;margin-bottom:14px;background:#fff;border:1px solid #dfe6ef;border-radius:8px;box-shadow:0 10px 24px rgba(15,23,42,.05)}.toolbar input{min-width:260px;flex:1}.panel{position:relative;padding:16px;background:#fff;border:1px solid #dfe6ef;border-radius:8px}.table-head{position:sticky;top:70px;z-index:35;justify-content:space-between;margin:-16px -16px 10px;padding:16px;color:#667085;background:#fff;border-bottom:1px solid #edf1f5;border-radius:8px 8px 0 0;font-size:12px}.table-scroll{max-height:calc(100vh - 380px);min-height:360px;overflow:auto;border-bottom:1px solid #edf1f5}table{width:max-content;min-width:100%;border-collapse:separate;border-spacing:0}.reorder-table thead th{position:sticky;top:0;z-index:25}.reorder-table th:first-child,.reorder-table td:first-child{position:sticky;left:0;z-index:18;width:44px;min-width:44px;background:#fff}.reorder-table th:first-child{z-index:32;background:#f8fafc}.reorder-table th:nth-child(2),.reorder-table td:nth-child(2){position:sticky;left:44px;z-index:17;min-width:230px;max-width:260px;background:#fff;box-shadow:8px 0 14px rgba(15,23,42,.06)}.reorder-table th:nth-child(2){z-index:31;background:#f8fafc}.reorder-table th:last-child,.reorder-table td:last-child{position:sticky;right:0;z-index:18;min-width:116px;background:#fff;box-shadow:-8px 0 14px rgba(15,23,42,.06)}.reorder-table th:last-child{z-index:32;background:#f8fafc}.reorder-table tbody tr:hover td{background:#fbfdff}.reorder-table tbody tr:hover td:first-child,.reorder-table tbody tr:hover td:nth-child(2),.reorder-table tbody tr:hover td:last-child{background:#fbfdff}.pagination{position:sticky;bottom:0;z-index:30;justify-content:flex-end;margin:0 -16px -16px;padding:12px 16px;background:#fff;border-top:1px solid #edf1f5;border-radius:0 0 8px 8px}th{padding:10px;color:#64748b;background:#f8fafc;border-bottom:1px solid #e6edf5;text-align:left;font-size:10px;font-weight:850;text-transform:uppercase;white-space:nowrap}td{padding:10px;border-bottom:1px solid #edf1f5;font-size:12px;vertical-align:top;white-space:nowrap}input,select,button{min-height:36px;padding:8px 10px;color:#344159;background:#fff;border:1px solid #d8e0eb;border-radius:8px;font-size:12px}button{font-weight:800;cursor:pointer}.primary{color:#fff;background:#2457d6;border-color:#2457d6}.link-button{display:grid;justify-items:start;min-height:0;padding:0;border:0;background:transparent}.link-button strong{color:#18243a}.link-button span{color:#667085;font-size:11px}.badge,.mini-pill{display:inline-flex;padding:5px 8px;border-radius:7px;font-size:10px;font-weight:850}.badge.out_of_stock{color:#b42318;background:#fff4f4}.badge.critical{color:#92400e;background:#fffbeb}.badge.low_stock{color:#175cd3;background:#eff8ff}.badge.reorder_required{color:#344054;background:#f2f4f7}.mini-pill{color:#175cd3;background:#eff8ff}.row-menu{display:flex;justify-content:flex-end;gap:6px}.action-cell{width:1%;text-align:right}.empty{padding:30px!important;text-align:center;color:#667085}.empty strong,.empty span{display:block}.success{display:flex;justify-content:space-between;gap:10px;margin-bottom:12px;padding:10px 12px;color:#067647;background:#ecfdf3;border:1px solid #abefc6;border-radius:8px;font-size:12px}.bulk-bar{position:fixed;z-index:920;left:calc(50% - 380px);right:24px;bottom:18px;justify-content:space-between;padding:12px 14px;background:#111827;color:#fff;border-radius:8px;box-shadow:0 20px 50px rgba(15,23,42,.25)}.bulk-bar div{display:flex;gap:8px;flex-wrap:wrap}.drawer-backdrop,.modal-backdrop{position:fixed;z-index:960;inset:0;background:rgba(15,23,42,.38)}.drawer-backdrop{display:flex;justify-content:flex-end}.drawer{width:min(520px,100%);height:100vh;overflow:auto;padding:18px;background:#fff}.drawer-head{justify-content:space-between;margin-bottom:14px}.drawer-head h3{margin:2px 0 0;color:#142139}.detail-grid{display:grid;gap:12px}.detail-grid article,.preview-group{padding:14px;border:1px solid #e4eaf2;border-radius:8px}.detail-grid h4,.preview-group h4{margin:0 0 8px;color:#142139}.detail-grid p,.preview-group p{margin:6px 0;color:#667085}.modal-backdrop{display:grid;place-items:center;padding:20px}.modal{width:min(980px,100%);max-height:calc(100vh - 40px);overflow:auto;padding:18px;background:#fff;border-radius:8px}.expected{display:grid;gap:6px;max-width:260px;margin-bottom:12px;color:#526077;font-size:11px;font-weight:850}.modal-actions{justify-content:flex-end;margin-top:14px}@media(max-width:1200px){.kpis{grid-template-columns:repeat(3,minmax(0,1fr))}.bulk-bar{left:18px}}@media(max-width:760px){.toolbar,.table-head,.pagination{position:static}.page-head,.table-head,.success{align-items:stretch;flex-direction:column}.actions button,.toolbar input,.toolbar select,.toolbar button{width:100%;min-width:0}.kpis{grid-template-columns:1fr}.table-scroll{max-height:none;min-height:0;overflow-x:auto}.reorder-table thead{display:none}.reorder-table,.reorder-table tbody,.reorder-table tr,.reorder-table td{display:block;width:100%}.reorder-table tr{margin-bottom:12px;padding:10px;border:1px solid #e4eaf2;border-radius:8px}.reorder-table td,.reorder-table td:first-child,.reorder-table td:nth-child(2),.reorder-table td:last-child{position:static;display:grid;grid-template-columns:135px minmax(0,1fr);gap:8px;border:0;white-space:normal;box-shadow:none}.reorder-table td::before{content:attr(data-label);color:#667085;font-size:11px;font-weight:850}.row-menu{display:grid}.bulk-bar{display:grid;left:12px;right:12px}.bulk-bar div{display:grid}.modal table{min-width:680px}}
</style>
