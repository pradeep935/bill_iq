...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('app')->name('app.')->group(function () {
        ...
        Route::prefix('purchase')->name('purchase.')->group(function () {
            ...
            Route::get('/reorder/references', [PurchaseController::class, 'reorderReferences'])->name('reorder.references');
            Route::get('/reorder/list', [PurchaseController::class, 'reorderList'])->name('reorder.list');
            Route::post('/reorder/requisitions', [PurchaseController::class, 'reorderCreateRequisition'])->name('reorder.requisitions');
            Route::post('/reorder/purchase-orders', [PurchaseController::class, 'reorderCreatePurchaseOrders'])->name('reorder.purchase-orders');
            Route::get('/orders', [PurchaseController::class, 'orders'])->name('orders');
            Route::get('/orders/references', [PurchaseController::class, 'inventoryOrderReferences'])->name('inventory-orders.references');
            Route::get('/orders/list', [PurchaseController::class, 'inventoryOrderList'])->name('inventory-orders.list');
            Route::get('/orders/products/search', [PurchaseController::class, 'inventoryOrderProducts'])->name('inventory-orders.products.search');
            Route::post('/orders', [PurchaseController::class, 'inventoryOrderSave'])->name('inventory-orders.store');
            Route::put('/orders/{order}', [PurchaseController::class, 'inventoryOrderSave'])->name('inventory-orders.update');
            Route::post('/orders/{order}/mark-ordered', [PurchaseController::class, 'inventoryOrderMarkOrdered'])->name('inventory-orders.mark-ordered');
            Route::post('/orders/{order}/cancel', [PurchaseController::class, 'inventoryOrderCancel'])->name('inventory-orders.cancel');
            Route::get('/order-management/references', [OrderManagementController::class, 'references'])->name('orders.references');
            Route::get('/order-management/products/search', [OrderManagementController::class, 'searchProducts'])->name('orders.products.search');
            Route::get('/order-management/dashboard', [OrderManagementController::class, 'dashboard'])->name('orders.dashboard');
            Route::get('/order-management/reports', [OrderManagementController::class, 'reports'])->name('orders.reports');
